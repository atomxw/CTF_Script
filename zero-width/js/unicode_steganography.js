...
/**
  ...
  return: null
  */
let setUseChars = function(newchars){
...
/**
  ...
  */
let encodeText = function(text1, text2){
...
/**
  ...
  return: unicode stego text
  */
let encodeBinary = function(text, data){
...
/**
  ...
  */
let decodeBinary = function(text){
  let splitted = split_zerowidth_characters(text);
...
/**
  Internal Functions
*/
let encode_to_zerowidth_characters_text = function(str1){
...
let encode_to_zerowidth_characters_binary = function(u8ary){
...
let combine_shuffle_string = function(str1, str2, codelength){
  let result = [];
...
let split_zerowidth_characters = function(str1){
  let result = {};
...
let decode_from_zero_width_characters_text = function(str1){
  let r = str1;
  let i;
  let result = [];
  for(i = 0; i < radix; i++){
...
let decode_from_zero_width_characters_binary = function(str1){
  let r = str1;
  let i;
  let j;
...
// let cipher_text = "Flag‍‍‌‌‍‬‌‍{thi‍﻿‌﻿‍﻿‌﻿‍‍‍﻿‍‬﻿﻿‍﻿‌‬‍‬‍‌_is_flag}";

// console.log(unicodeSteganographer.decodeText(cipher_text));
// console.log(unicodeSteganographer.decodeBinary(cipher_text));